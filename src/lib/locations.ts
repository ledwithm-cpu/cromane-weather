...
export const LOCATIONS: Location[] = [
  // Kerry
  {
    ...
    tideStation: 'Fenit', tideOffsetMinutes: 25, chartDatumOffset: 2.67,
  ...
  },
  {
    ...
    county: 'Kerry', province: 'Munster',
    tideStation: 'Fenit', tideOffsetMinutes: 10, chartDatumOffset: 2.67,
    metEireannStation: 'valentia',
  ...
  },
  {
    ...
    county: 'Kerry', province: 'Munster',
    tideStation: 'Fenit', tideOffsetMinutes: 12, chartDatumOffset: 2.67,
    metEireannStation: 'valentia',
  ...
  },
  {
    ...
    county: 'Kerry', province: 'Munster',
    tideStation: 'Fenit', tideOffsetMinutes: 20, chartDatumOffset: 2.67,
    metEireannStation: 'valentia',
  ...
  },
  {
    ...
    county: 'Kerry', province: 'Munster',
    tideStation: 'Fenit', tideOffsetMinutes: 15, chartDatumOffset: 2.67,
    metEireannStation: 'valentia',
  ...
  },
  {
    ...
    county: 'Kerry', province: 'Munster',
    tideStation: 'Fenit', tideOffsetMinutes: 8, chartDatumOffset: 2.67,
    metEireannStation: 'valentia',
    saunaName: 'Brandon Bay Sauna',
    saunaUrl: 'https://www.brandonbaysauna.com',
  },
  ...
  },
  {
    ...
    county: 'Kerry', province: 'Munster',
    tideStation: 'Fenit', tideOffsetMinutes: 5, chartDatumOffset: 2.67,
    metEireannStation: 'valentia',
  ...
  },
  {
    ...
    county: 'Kerry', province: 'Munster',
    tideStation: 'Fenit', tideOffsetMinutes: 22, chartDatumOffset: 2.67,
    metEireannStation: 'valentia',
  ...
  },
  {
    ...
    county: 'Kerry', province: 'Munster',
    tideStation: 'Fenit', tideOffsetMinutes: 30, chartDatumOffset: 2.67,
    metEireannStation: 'valentia',
  ...
  },
  {
    ...
    county: 'Kerry', province: 'Munster',
    tideStation: 'Fenit', tideOffsetMinutes: 32, chartDatumOffset: 2.67,
    metEireannStation: 'valentia',
    saunaName: 'Skellig Sauna',
    saunaUrl: 'https://www.skelligsauna.ie',
  },
  {
    ...
    county: 'Kerry', province: 'Munster',
    tideStation: 'Fenit', tideOffsetMinutes: 33, chartDatumOffset: 2.67,
    metEireannStation: 'valentia',
  ...
  },
  {
    ...
    county: 'Kerry', province: 'Munster',
    tideStation: 'Fenit', tideOffsetMinutes: 35, chartDatumOffset: 2.67,
    metEireannStation: 'valentia',
    saunaName: 'Fire & Ice',
  ...
  // Cork
  {
    ...
    tideStation: 'Cobh', tideOffsetMinutes: 15, chartDatumOffset: 2.51,
  ...
  },
  {
    ...
    county: 'Cork', province: 'Munster',
    tideStation: 'Cobh', tideOffsetMinutes: 18, chartDatumOffset: 2.51,
    metEireannStation: 'roches-point',
    saunaName: 'Wild Wellness',
    saunaUrl: 'https://www.wildwellness.ie',
  },
  {
    ...
    county: 'Cork', province: 'Munster',
    tideStation: 'Cobh', tideOffsetMinutes: 30, chartDatumOffset: 2.51,
    metEireannStation: 'roches-point',
  ...
  },
  {
    ...
    county: 'Cork', province: 'Munster',
    tideStation: 'Cobh', tideOffsetMinutes: 28, chartDatumOffset: 2.51,
    metEireannStation: 'roches-point',
  ...
  },
  {
    ...
    county: 'Cork', province: 'Munster',
    tideStation: 'Cobh', tideOffsetMinutes: 29, chartDatumOffset: 2.51,
    metEireannStation: 'roches-point',
  ...
  },
  {
    ...
    county: 'Cork', province: 'Munster',
    tideStation: 'Castletownbere', tideOffsetMinutes: 20, chartDatumOffset: 2.09,
  ...
  },
  {
    ...
    county: 'Cork', province: 'Munster',
    tideStation: 'Cobh', tideOffsetMinutes: 5, chartDatumOffset: 2.51,
    metEireannStation: 'sherkin-island',
  ...
  },
  {
    ...
    county: 'Cork', province: 'Munster',
    tideStation: 'Cobh', tideOffsetMinutes: 10, chartDatumOffset: 2.51,
    metEireannStation: 'roches-point',
  ...
  // Clare
  {
    ...
    tideStation: 'Galway', tideOffsetMinutes: -30, chartDatumOffset: 2.97,
  ...
  },
  {
    ...
    county: 'Clare', province: 'Munster',
    tideStation: 'Galway', tideOffsetMinutes: -20, chartDatumOffset: 2.97,
    metEireannStation: 'shannon',
  },
  // Galway
  {
    ...
    tideStation: 'Galway', tideOffsetMinutes: 5, chartDatumOffset: 2.97,
  ...
  },
  {
    ...
    county: 'Galway', province: 'Connacht',
    tideStation: 'Galway', tideOffsetMinutes: -15, chartDatumOffset: 2.97,
    metEireannStation: 'athenry',
    saunaName: 'Driftwood Sauna',
    saunaUrl: 'https://www.driftwoodsaunas.ie',
  },
  // Mayo
  {
    ...
    tideStation: 'Ballyglass', tideOffsetMinutes: -10, chartDatumOffset: 2.1,
  ...
  // Sligo
  {
    ...
    tideStation: 'Ballyglass', tideOffsetMinutes: 20, chartDatumOffset: 2.1,
    metEireannStation: 'knock',
  },
  // Donegal
  {
    ...
    tideStation: 'Ballyglass', tideOffsetMinutes: 25, chartDatumOffset: 2.1,
  ...
  },
  {
    ...
    county: 'Donegal', province: 'Ulster',
    tideStation: 'Ballyglass', tideOffsetMinutes: 23, chartDatumOffset: 2.1,
    metEireannStation: 'malin-head',
    saunaName: 'Salt & Ember',
    saunaUrl: 'https://www.saltandember.ie',
  },
  {
    ...
    county: 'Donegal', province: 'Ulster',
    tideStation: 'Aranmore', tideOffsetMinutes: 10, chartDatumOffset: 2.2,
    metEireannStation: 'malin-head',
  ...
  },
  {
    ...
    county: 'Donegal', province: 'Ulster',
    tideStation: 'Aranmore', tideOffsetMinutes: 12, chartDatumOffset: 2.2,
    metEireannStation: 'malin-head',
    saunaName: 'Sliabh Liag Sauna',
    saunaUrl: 'https://www.sliabhliagsauna.ie',
  },
  {
    ...
    county: 'Donegal', province: 'Ulster',
    tideStation: 'Aranmore', tideOffsetMinutes: 15, chartDatumOffset: 2.2,
    metEireannStation: 'malin-head',
  ...
  // Dublin
  {
    ...
    tideStation: 'Howth', tideOffsetMinutes: 5, chartDatumOffset: 2.68,
  ...
  },
  {
    ...
    county: 'Dublin', province: 'Leinster',
    tideStation: 'Howth', tideOffsetMinutes: 8, chartDatumOffset: 2.68,
    metEireannStation: 'dublin-airport',
  ...
  },
  {
    ...
    county: 'Dublin', province: 'Leinster',
    tideStation: 'Howth', tideOffsetMinutes: 3, chartDatumOffset: 2.68,
    metEireannStation: 'dublin-airport',
  ...
  },
  {
    ...
    county: 'Dublin', province: 'Leinster',
    tideStation: 'Howth', tideOffsetMinutes: 4, chartDatumOffset: 2.68,
    metEireannStation: 'dublin-airport',
  ...
  },
  {
    ...
    county: 'Dublin', province: 'Leinster',
    tideStation: 'Howth', tideOffsetMinutes: -2, chartDatumOffset: 2.68,
    metEireannStation: 'dublin-airport',
    saunaName: 'Fad Saoil Saunas',
    saunaUrl: 'https://www.fadsaoilsaunas.com',
  },
  {
    ...
    county: 'Dublin', province: 'Leinster',
    tideStation: 'Howth', tideOffsetMinutes: -1, chartDatumOffset: 2.68,
    metEireannStation: 'dublin-airport',
    saunaName: 'Fad Saoil Saunas',
    saunaUrl: 'https://www.fadsaoilsaunas.com',
  },
  ...
  },
  {
    ...
    county: 'Dublin', province: 'Leinster',
    tideStation: 'Howth', tideOffsetMinutes: 0, chartDatumOffset: 2.68,
    metEireannStation: 'dublin-airport',
    saunaName: 'Restore Sauna',
    saunaUrl: 'https://www.restoresauna.ie',
  },
  {
    ...
    county: 'Dublin', province: 'Leinster',
    tideStation: 'Howth', tideOffsetMinutes: 10, chartDatumOffset: 2.68,
    metEireannStation: 'dublin-airport',
    saunaName: 'The Sea Sauna',
    saunaUrl: 'https://www.theseasauna.ie',
  },
  // Wicklow
  {
    ...
    tideStation: 'Arklow', tideOffsetMinutes: -10, chartDatumOffset: 0.59,
    metEireannStation: 'dublin-airport',
    saunaName: 'Fad Saoil Saunas',
    saunaUrl: 'https://www.fadsaoilsaunas.com',
  },
  ...
  // Wexford
  {
    ...
    tideStation: 'Arklow', tideOffsetMinutes: 20, chartDatumOffset: 0.59,
    metEireannStation: 'johnstown-castle',
  ...
  },
  {
    ...
    county: 'Wexford', province: 'Leinster',
    tideStation: 'Arklow', tideOffsetMinutes: 15, chartDatumOffset: 0.59,
    metEireannStation: 'johnstown-castle',
  ...
  // Louth
  {
    ...
    tideStation: 'Howth', tideOffsetMinutes: 15, chartDatumOffset: 2.68,
    metEireannStation: 'dublin-airport',
