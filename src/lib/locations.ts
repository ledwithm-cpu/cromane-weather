...
export const LOCATIONS: Location[] = [
  ...
  // Wicklow
  {
    ...
    tideStation: 'Arklow', tideOffsetMinutes: -10, chartDatumOffset: 1.78,
    metEireannStation: 'dublin-airport',
    saunaName: 'Fad Saoil Saunas',
    saunaUrl: 'https://www.fadsaoilsaunas.com',
  },
  ...
  // Wexford
  {
    ...
    tideStation: 'Arklow', tideOffsetMinutes: 20, chartDatumOffset: 1.78,
    metEireannStation: 'johnstown-castle',
  ...
  },
  {
    ...
    county: 'Wexford', province: 'Leinster',
    tideStation: 'Arklow', tideOffsetMinutes: 15, chartDatumOffset: 1.78,
    metEireannStation: 'johnstown-castle',
